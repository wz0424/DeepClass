...
public class TeacherLand extends AppCompatActivity implements View.OnClickListener {
    //定义登录的姓名和ID号
    String id, password;
    //定义登录按钮
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readRequest();
        MyHelper helper=new MyHelper(TeacherLand.this);
    }
    //登录按钮被点击
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.register){
            ...
            if (id.equals("") || password.equals("")) {
                ...
                SQLiteDatabase db;
                MyHelper ggg = new MyHelper(TeacherLand.this);
