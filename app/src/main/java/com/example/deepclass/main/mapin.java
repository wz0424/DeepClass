...
public class mapin extends BaseActivity implements SensorEventListener, View.OnClickListener {
    /**
     * 规定到达距离范围距离
     */
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        la2=Double.parseDouble(la);
        lo2=Double.parseDouble(lo);
        setTitle("打卡签到");
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //打卡范围
            mDestinationPoint = new LatLng(la2, lo2);//假设公司坐标
            setCircleOptions();
            //计算两点距离,单位：米
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.arriver_bt) {
            if (mDistance <= DISTANCE) {
                SQLiteDatabase db;
                MyHelper ggg = new MyHelper(mapin.this);
                ...
                ggg.Insert_two(db, "attendance", id,name,df.format(new java.util.Date()));
