...
public class ToastUtil {
    ...
    public static void showImageToas(Context context, String message){
        ...
        View toastview= LayoutInflater.from(context).inflate(R.layout.toast_image,null);
    ...
    public static void showTextToas(Context context,String message){
        ...
        View toastview= LayoutInflater.from(context).inflate(R.layout.toast_text,null);
